...
class Color{
	...
	function randomColor(){
		$color = array_rand($this->colornames);
		//_makeWebSafe($color);
		$p0 = dechex($this->colornames[$color][0]);
		$p1 = dechex($this->colornames[$color][1]);
		$p2 = dechex($this->colornames[$color][2]);
		$ret = strtoupper("#".$p0.$p1.$p2);
		return $ret;
	}
}
$Color = new Color();